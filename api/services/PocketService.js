...
module.exports = {
    ...
    /**
     * Cập nhật số dư và checksum bằng thuật toán OCC (Optimistic Concurrency Control)
     */
        ...
        while (retries < maxRetries) {
            ...
            const modifiedCount = await new Promise((resolve, reject) => {
                Pocket.native(function (err, collection) {
                    ...
                    collection.updateOne(
                        { _id: objectId, checksum: oldChecksum }, // Điều kiện Race Condition
            ...
            // Có sự thay đổi xen ngang (modifiedCount === 0), thử lại
            retries++;
